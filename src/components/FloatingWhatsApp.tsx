...
const FloatingWhatsApp = () => {
  return (
    <a
      ...
      className="fixed bottom-8 right-8 bg-gradient-to-br from-green-500 to-green-600 text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl z-[60] hover:scale-110 hover:shadow-green-500/50 transition-all duration-300 animate-pulse-slow"
